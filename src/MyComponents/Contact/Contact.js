            ...
            <div className={Contactcss.bothside}>
                ...
                <div className={Contactcss.rightside} >
                    <div className={Contactcss.rightheading}>
                        <p> <b className={Contactcss.yourstory}>What's Your story?</b> Get in touch. Always available for freelancing if the right project comes along me.</p>
                    </div>
